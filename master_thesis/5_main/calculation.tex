...
\end{equation*}
Розпишемо через модуль та скористаємося симетричністю гаусового розподілу
\begin{equation*}
  \mathbb{P}\left(
    \left|
      \sqrt{N}
...
\end{equation*}
Поділимо обидві частини нерівності, ймовірність котрої рахується,
на модуль середнього значення виборки
\begin{equation*}
  \mathbb{P}\left(
    \left|
      \sqrt{N}
...
\begin{equation*}
  z^2_{\gamma} = 2 \cdot \Phi^{-1}\left( 0.99 \right)^2 - 1 = 2.575^2.
\end{equation*}
Середнє значення
\begin{equation*}
