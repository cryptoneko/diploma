...
\begin{equation*}
  q^* \left( t \right)
  = \argmax_x \mathbb{P} \left( x,  t \right).
\end{equation*}
...
що параметри належать її $\delta$-околиці була більшою,
ніж для $\delta$-околиць інших точок.
