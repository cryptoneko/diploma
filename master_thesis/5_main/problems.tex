...
Взагалі кажучи, $I$ --- множина матриць однакового розміру.
...
Тривимірна модель обличчя визначається набором з $n$ дійсних параметрів.
Позначимо їх через $x$.
